...
Rafael (Request handler / CGI / responder): recebe Request, escolhe ServerConfig/Location, executa CGI ou lê ficheiro estático, gera Response (headers + body), gerencia Connection: close/keep-alive e passa o Response para escrita (Roberto envia a response pra centralizar I/O).
